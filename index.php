...
function setMarginsLTO() {
    ...
    document.getElementById('marginPageLeft').value=16;
    document.getElementById('marginPageTop').value=32.5;
    document.getElementById('spacingCol').value=22;
    document.getElementById('spacingRow').value=8.25;
}
...
?>
        ...
        <form name="barcodeGenerator" method="post" action="print.php">
            <table>
                ...
                <tr>
                    <th>Prefix: </th>
                    <td><input type="text" maxlength=6 name="prefix" id="prefix" value="AMA" /></td>
